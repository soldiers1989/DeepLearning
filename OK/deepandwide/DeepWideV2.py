...
from obsoleted.LibSVMFormatInput import LoadLibSvmData


#################### Arguments ####################

class DeepWide(BaseEstimator, TransformerMixin):
  ...
  def inference(self, input_tensor, istrain=True):      
    # Model.
    # ________ Deep Layers __________
    self.NN = input_tensor
