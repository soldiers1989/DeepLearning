...
births_trimmed = births.select(selected_features) # select feature
...
# pyspark.sql.functions �ڽ�����
# udf ������һ����ͨ�����ú�����������������װ��ͨ�� python ���������� select �� withColumn ֧�ֵı任����
