...
param2 = {
  ...
  'predset': ['pred.csv.num'],
  'dimquery': 13715,
  'dimdoc': 12774,
  'output': '3.pred',
  'model': '/mnt/yardcephfs/mmyard/g_wxg_ob_dc/bincai/hot_mp/src/data0417/model.20180419081457.h5py',
  'querymodel': '/mnt/yardcephfs/mmyard/g_wxg_ob_dc/bincai/hot_mp/src/data0417/query.model.20180419081457.h5py',
  'docmodel': '/mnt/yardcephfs/mmyard/g_wxg_ob_dc/bincai/hot_mp/src/data0417/doc.model.20180419081457.h5py'
}
...
if __name__ == '__main__':
  model = load_model(param['model'], custom_objects={'paper_loss': paper_loss,
                                                     ...
                                                     'auc': auc}) if 'model' in param and os.path.isfile(
    param['model']) else None
  ...
  querymodel = load_model(param['querymodel'], custom_objects={'paper_loss': paper_loss,
                                                               ...
                                                               'binary_PFA': binary_PFA,
                                                               'binary_PTA': binary_PTA,
                                                               'auc': auc}) if 'querymodel' in param and os.path.isfile(
    param['querymodel']) else None
  ...
  docmodel = load_model(param['docmodel'], custom_objects={'paper_loss': paper_loss,
                                                           ...
                                                           'binary_PFA': binary_PFA,
                                                           'binary_PTA': binary_PTA,
                                                           'auc': auc}) if 'docmodel' in param and os.path.isfile(
    param['docmodel']) else None
