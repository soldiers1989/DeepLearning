...
model_dir = '/mnt/yardcephfs/mmyard/g_wxg_ob_dc/bincai/data/CensusIncomeDataSet/d_w_model'
...
df_train = pd.read_csv(
    tf.gfile.Open('/mnt/yardcephfs/mmyard/g_wxg_ob_dc/bincai/data/CensusIncomeDataSet/adult.data'),
    names=COLUMNS,
...
df_test = pd.read_csv(
    tf.gfile.Open('/mnt/yardcephfs/mmyard/g_wxg_ob_dc/bincai/data/CensusIncomeDataSet/adult.test'),
    names=COLUMNS,
    skipinitialspace=True,
    engine="python",
    skiprows=1)
...
# IV step
servable_model_dir = "/mnt/yardcephfs/mmyard/g_wxg_ob_dc/bincai/data/CensusIncomeDataSet/serving_savemodel"
