...
(4,'userfullshortreadldamap',1,1600),
(5,'usernotclickldamap',1,1600),
(6,'bizmsgldamap',1,1600),
(7,'msgreadldamap',1,1600),
(8,'userlongreadtagvec',1,300),
(9,'usershortreadtagvec',1,300),
(10,'usernotclicktagvec',1,300),
(11,'msgreadtagvec',1,300),
(12,'userlongreadtagmap',1,100000),
(13,'usershortreadtagmap',1,100000),
(14,'usernotclicktagmap',1,100000),
(15,'msgreadtagmap',1,100000),
(16,'bizuin',1,400000),
(17,'region',1,5000),
(18,'level',1,6),
(19,'normalizedfeats',1,35)
]
'''
      ))
    else:
      assert 1 == 0, 'Data version error'
    ...
    self.ansy_run = True
    self.traindataqueue = Queue(maxsize=10)
    self.testdataqueue = Queue(maxsize=2)
  ...
  def create_feature_cross_info(self):
    ...
    if self.feature_cross:
      ...
      if self.dataversion == 8:
        self.create_feature_cross2d(0, 13)
        self.create_feature_cross2d(1, 13)
        self.create_feature_cross3d(0, 1, 13)
        self.create_feature_cross2d(2, 13)
        self.create_feature_cross2d(11, 13)
  ...
  def do_ansyc_trainset(self):
    ...
    while self.ansy_run:
      ...
      ele = self.processing_batch(lines)
      if ele['D']==0: break
      self.traindataqueue.put(ele)
