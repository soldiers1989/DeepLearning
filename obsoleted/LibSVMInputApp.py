  ...
  def processing_feature(self, fields):
    ...
    for item in fields[1:]:
      ...
      if (idx in self.idmap) and (val != 0):
        feature[self.idmap[idx] - 1] = val
        print('self.idmap[idx] - 1 %d value %f'%(self.idmap[idx] - 1,val))
...
if __name__ == '__main__':
  ...
  parser.add_argument('--inputpath', default='wxappaudit/', required=False,
  ...
  parser.add_argument('--shuffle_file', type=str2bool, default=False,
